	...
	var LatexHighlightRules = function() {
		this.$rules = {
			"start": [{
				...
				token: ["entity.name.reference", "lparen", "variable.parameter", "rparen"],
				regex: "(\\\\(?:label|ref|vref))({)([^}]*)(})"
			}, {
				token: ["support.function.cite", "lparen", "variable.parameter", "rparen"],
				regex: "(\\\\cite(?:[^{]*))({)([^}]*)(})"
				...
				// token: ["support", "lparen", "constant.numeric", "rparen"],
				// regex: "(\\\\[a-zA-Z]+)({)([^}]*)?(})"
