...
<div id="installer">
	...
	if (!$config || !$workspace || !$plugins || !$data || $register || $newrelic) {
		$passed = "<span style=\"color:green\">" . i18n("passed") . "</span>";
		$failed = "<span style=\"color:red\">" . i18n("failed") . "</span>";
		...
		<form id="install">
			...
			<div id="dependencies">
				...
				foreach (array("ZIP", "OpenSSL", "MBString") as $dep) {
					$type = extension_loaded(strtolower($dep)) ? "success" : "error";
					echo("<span class=\"success\"><i class=\"success fas fa-circle\"></i>$dep</span>");
				}
				?>
			</div>
