// Creation Time: 2020-02-15 12:45:42
...
// js/chronometer.js
(function(global){var atheos=global.atheos,amplify=global.amplify;amplify.subscribe('atheos.loaded',function(){atheos.chrono.init()});atheos.chrono={kilo:'',mega:'',giga:'',init:function(){console.log('Chronometer Initialized');var chrono=this;kilo=setInterval(function(){amplify.publish('chrono.kilo')},1000);mega=setInterval(function(){amplify.publish('chrono.mega')},10000);giga=setInterval(function(){amplify.publish('chrono.giga')},100000)},}}(this));
// js/confirm.js
