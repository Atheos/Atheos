...
return ret!==false;},subscribe:function(topic,context,callback,priority){if(typeof topic!=="string"){throw new Error("You must provide a valid topic to create a subscription.");}
...
var length=subscriptions[topic].length,i=0;for(;i<length;i++){if(subscriptions[topic][i].callback===callback){if(!context||subscriptions[topic][i].context===context){subscriptions[topic].splice(i,1);i--;length--;}}}}};}(this));;(function(){var window=this;if(!window.localStorage){if(window.globalStorage){try{window.localStorage=window.globalStorage;}catch(e){}
return;}
var div=document.createElement("div"),attrKey="localStorage";div.style.display="none";document.getElementsByTagName("head")[0].appendChild(div);if(div.addBehavior){div.addBehavior("#default#userdata");var localStorage=window["localStorage"]={"length":0,"setItem":function(key,value){div.load(attrKey);key=cleanKey(key);if(!div.getAttribute(key)){this.length++;}
div.setAttribute(key,value);div.save(attrKey);},"getItem":function(key){div.load(attrKey);key=cleanKey(key);return div.getAttribute(key);},"removeItem":function(key){div.load(attrKey);key=cleanKey(key);div.removeAttribute(key);div.save(attrKey);this.length--;if(this.length<0){this.length=0;}},"clear":function(){div.load(attrKey);var i=0;while(attr=div.XMLDocument.documentElement.attributes[i++]){div.removeAttribute(attr.name);}
div.save(attrKey);this.length=0;},"key":function(key){div.load(attrKey);return div.XMLDocument.documentElement.attributes[key];}},cleanKey=function(key){return key.replace(/[^-._0-9A-Za-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u37f-\u1fff\u200c-\u200d\u203f\u2040\u2070-\u218f]/g,"-");};div.load(attrKey);localStorage["length"]=div.XMLDocument.documentElement.attributes.length;}}})();;!function(e,t){if("function"==typeof define&&define.amd)define("hoverintent",["module"],t);else if("undefined"!=typeof exports)t(module);else{var n={exports:{}};t(n),e.hoverintent=n.exports}}(this,function(e){"use strict";var t=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(e[o]=n[o])}return e};e.exports=function(e,n,o){function i(e,t){return y&&(y=clearTimeout(y)),b=0,p?void 0:o.call(e,t)}function r(e){m=e.clientX,d=e.clientY}function u(e,t){if(y&&(y=clearTimeout(y)),Math.abs(h-m)+Math.abs(E-d)<x.sensitivity)return b=1,p?void 0:n.call(e,t);h=m,E=d,y=setTimeout(function(){u(e,t)},x.interval)}function s(t){return L=!0,y&&(y=clearTimeout(y)),e.removeEventListener("mousemove",r,!1),1!==b&&(h=t.clientX,E=t.clientY,e.addEventListener("mousemove",r,!1),y=setTimeout(function(){u(e,t)},x.interval)),this}function c(t){return L=!1,y&&(y=clearTimeout(y)),e.removeEventListener("mousemove",r,!1),1===b&&(y=setTimeout(function(){i(e,t)},x.timeout)),this}function v(t){L||(p=!0,n.call(e,t))}function a(t){!L&&p&&(p=!1,o.call(e,t))}function f(){e.addEventListener("focus",v,!1),e.addEventListener("blur",a,!1)}function l(){e.removeEventListener("focus",v,!1),e.removeEventListener("blur",a,!1)}var m,d,h,E,L=!1,p=!1,T={},b=0,y=0,x={sensitivity:7,interval:100,timeout:0,handleFocus:!1};return T.options=function(e){var n=e.handleFocus!==x.handleFocus;return x=t({},x,e),n&&(x.handleFocus?f():l()),T},T.remove=function(){e&&(e.removeEventListener("mouseover",s,!1),e.removeEventListener("mouseout",c,!1),l())},e&&(e.addEventListener("mouseover",s,!1),e.addEventListener("mouseout",c,!1)),T}});;(function(root,factory){if(typeof define==='function'&&define.amd){define([],function(){return factory(root);});}else if(typeof exports==='object'){module.exports=factory(root);}else{root.ajax=factory(root);}})(typeof global!=='undefined'?global:typeof window!=='undefined'?window:this,function(window){'use strict';function formatParams(data,random){var arr=[];if(data&&typeof data==='object'){for(var name in data){arr.push(encodeURIComponent(name)+'='+encodeURIComponent(data[name]));}}
if(random){arr.push(('v='+Math.random()).replace('.',''));}
return arr.join('&');}
const ajax=function(options){options=options||{};options.type=(options.type||'GET').toUpperCase();options.dataType=options.dataType||'json';var params=formatParams(options.data,false);var xhr;if(window.XMLHttpRequest){xhr=new XMLHttpRequest();}else{xhr=new ActiveXObject('Microsoft.XMLHTTP');}
...
return null;};IconTables.prototype.matchPath=function(path,directory){directory=directory!==undefined?directory:false;var cachedIcons=directory?cache.directoryName:cache.fileName;var icons=directory?this.directoryIcons.byPath:this.fileIcons.byPath;if(cachedIcons[name]){return cachedIcons[name];}
...
return new FileIcons(icondb)});;(function(root,factory){if(typeof define==='function'&&define.amd){define([],function(){return factory(root);});}else if(typeof exports==='object'){module.exports=factory(root);}else{root.onyx=factory(root);}})(typeof global!=='undefined'?global:typeof window!=='undefined'?window:this,function(window){'use strict';var activeEvents={};var getIndex=function(arr,selector,callback){for(var i=0;i<arr.length;i++){if(arr[i].selector===selector&&arr[i].callback.toString()===callback.toString()){return i;}}
return-1;};var doRun=function(target,selector){if(['*','window','document','document.documentElement',window,document,document.documentElement].indexOf(selector)>-1)return true;if(typeof selector!=='string'&&selector.contains){return selector===target||selector.contains(target);}
...
types.split(',').forEach(function(type){type=type.trim();if(!activeEvents[type]){activeEvents[type]=[];window.addEventListener(type,eventHandler,true);}
activeEvents[type].push({selector:selector,callback:callback});});},off:function(types,selector,callback){types.split(',').forEach(function(type){type=type.trim();if(!activeEvents[type])return;if(activeEvents[type].length<2||!selector){delete activeEvents[type];window.removeEventListener(type,eventHandler,true);return;}
...
return element.getAttribute(k);},removeAttr:function(k){element.removeAttribute(k);return this;},parent:function(){return element.parentNode;},children:function(){return element.childNodes;},find:function(s){return onyx(element.querySelector(s));},remove:function(){element.remove();return this;},before:insertAdjacent('beforebegin'),after:insertAdjacent('afterend'),first:insertAdjacent('afterbegin'),last:insertAdjacent('beforeend'),insertBefore:insertToAdjacent('beforebegin'),insertAfter:insertToAdjacent('afterend'),insertFirst:insertToAdjacent('afterbegin'),insertLast:insertToAdjacent('beforeend'),prepend:insertAdjacent('afterbegin'),append:insertAdjacent('beforeend'),getAttr:v=>element.getAttribute(v),offset:()=>element.getBoundingClientRect(),outerHeight:element.outerHeight,outerWidth:element.outerWidth,clientHeight:function(){return element.clientHeight;},clientWidth:function(){return element.clientWidth;},style:element.style,el:element,isOnyx:true};};return onyx;});;(function(global,$){var core=global.core=global.codiad={},amplify=global.amplify,o=global.onyx;$.loadScript=function(url,arg1,arg2){console.trace('$.loadScript is depreciated, please use "core.helpers.loadScript"');core.helpers.loadScript(url,arg1,arg2);};$.ctrl=function(key,callback,args){console.trace('$.ctrl is depreciated, please use "core.keybind.bind"');core.keybind.bind(key,callback,args);};document.addEventListener("DOMContentLoaded",function(){if(document.querySelector('#login')){synthetic.init();}else{core.modal.init();core.sidebars.init();core.toast.init();amplify.publish('core.loaded',{});window.addEventListener('resize',function(){var handleWidth=10;var marginL,reduction;if(o("#sb-left").css('left')!==0&&!core.sidebars.settings.leftLockedVisible){marginL=handleWidth;reduction=2*handleWidth;}else{marginL=$('#sb-left').width();reduction=marginL+handleWidth;}
o('#editor-region').css({'margin-left':marginL+'px'});o('#editor-region').css({'margin-left':marginL+'px','height':(o('body').clientHeight())+'px'});o('#root-editor-wrapper').css({'height':(o('body').clientHeight()-57)+'px'});if(core.editor){core.editor.resize();core.active.updateTabDropdownVisibility();}});}});})(this,jQuery);;'use strict';var log=function(m,t){if(t){console.trace(m);}else{console.log(m);}};(function(global){var codiad=global.codiad;codiad.helpers={icons:{},settings:{},init:function(options){if(options){this.setings=this.extend(this.settings,options);}},file:{getShortName:function(path){return path.split('/').pop();},getExtension:function(path){return path.split('.').pop();},},extend:function(obj,src){for(var key in src){if(src.hasOwnProperty(key))obj[key]=src[key];}
return obj;},trigger:function(selector,event){if(!event||!selector)return;var element;if(selector.self==window){element=selector;}else{element=selector.nodeType===Node.ELEMENT_NODE?selector:document.querySelector(selector);}
if(element){if('createEvent'in document){var e=document.createEvent('HTMLEvents');e.initEvent(event,false,true);element.dispatchEvent(e);}else{var e=document.createEventObject();e.eventType=event;el.fireEvent('on'+e.eventType,e);}}},loadScript:function(url,arg1,arg2){var cache=true,callback=null;if(typeof arg1==='function'){callback=arg1;cache=arg2||cache;}else{cache=arg1||cache;callback=arg2||callback;}
var load=true;jQuery('script[type="text/javascript"]').each(function(){load=(url!==$(this).attr('src'));return load;});if(load){jQuery.ajax({type:'GET',url:url,success:callback,dataType:'script',cache:cache});}else{if(jQuery.isFunction(callback)){callback.call(this);}}}};})(this);;(function(root,factory){if(typeof define==='function'&&define.amd){define([],function(){return factory(root);});}else if(typeof exports==='object'){module.exports=factory(root);}else{root.synthetic=factory(root);}})(typeof global!=='undefined'?global:typeof window!=='undefined'?window:this,function(window){'use strict';const synthetic={canvas:null,init:function(options){this.canvas=document.getElementById('synthetic');if(!this.canvas){this.canvas=this.createCanvas();}
this.drawSynthetic();},createCanvas:function(){var container=document.createElement('canvas');container.id='synthetic';document.body.appendChild(container);return container;},drawSynthetic:function(){var hex={angle:0.523598776,sideLength:20,boardWidth:400,boardHeight:600};hex.height=Math.sin(hex.angle)*hex.sideLength;hex.radius=Math.cos(hex.angle)*hex.sideLength;hex.rectangleHeight=hex.sideLength+2*hex.height;hex.rectangleWidth=2*hex.radius;this.canvas.width=document.body.clientWidth+(hex.rectangleWidth*2);this.canvas.height=document.body.clientHeight+(hex.rectangleHeight*2);var boardWidth=this.canvas.width / hex.height,boardHeight=this.canvas.height / hex.height;if(this.canvas.getContext){var ctx=this.canvas.getContext('2d');ctx.lineWidth=1.5;this.drawBoard(ctx,boardWidth,boardHeight,hex);}},drawBoard:function(ctx,width,height,hex){var i,j,gradientX=255 / width,gradientY=255 / height,clrFill=['#0F0F0F','#090909','#0B0B0B','#0D0D0D'];ctx.strokeStle='rgba(0,0,0)';for(i=0;i<width;++i){for(j=0;j<height;++j){ctx.fillStyle=clrFill[Math.floor(Math.random()*clrFill.length)];this.draw(ctx,i*hex.rectangleWidth+((j%2)*hex.radius),j*(hex.sideLength+hex.height),hex);}}},draw:function(ctx,x,y,hex){ctx.beginPath();ctx.moveTo(x+hex.radius,y);ctx.lineTo(x+hex.rectangleWidth,y+hex.height);ctx.lineTo(x+hex.rectangleWidth,y+hex.height+hex.sideLength);ctx.lineTo(x+hex.radius,y+hex.rectangleHeight);ctx.lineTo(x,y+hex.sideLength+hex.height);ctx.lineTo(x,y+hex.height);ctx.closePath();ctx.globalAlpha=1;ctx.fill();ctx.globalAlpha=0.2;ctx.stroke();}};return synthetic;});(function(global){'use strict';var core=global.codiad,amplify=global.amplify,o=global.onyx,hoverintent=global.hoverintent;core.sidebars={settings:{leftLockedVisible:true,rightLockedVisible:false,isLeftSidebarOpen:true,isRightSidebarOpen:false,leftSidebarClickOpen:false,rightSidebarClickOpen:false},init:function(){amplify.subscribe('settings.loaded',function(settings){var sbLeftWidth=localStorage.getItem('codiad.sidebars.sb-left-width'),sbRightWidth=localStorage.getItem('codiad.sidebars.sb-left-width');if(sbLeftWidth!==null){o('#sb-left').style.width=sbLeftWidth;}
if(sbRightWidth!==null){o('#sb-left').style.width=sbRightWidth;}
core.sidebars.leftSidebarClickOpen=localStorage.getItem('codiad.sidebars.leftSidebarClickOpen');core.sidebars.rightSidebarClickOpen=localStorage.getItem('codiad.sidebars.rightSidebarClickOpen');if(localStorage.getItem('codiad.sidebars.sb-left-lock')==='false'){o('#sb-left-lock').trigger('click');core.sidebars.sbLeft.close();}
if(localStorage.getItem('codiad.sidebars.sb-right-lock')==='true'){o('#sb-right-lock').trigger('click');core.sidebars.sbRight.open();}
core.helpers.trigger(window,'resize');o('#editor-region').trigger('h-resize-init');});this.sbLeft.init();this.sbRight.init();},sbLeft:{sidebar:'',handle:'',icon:'',init:function(){this.sidebar=o('#sb-left');this.handle=o('#sb-left-handle');this.icon=o('#sb-left-lock');this.icon.on('click',function(e){core.sidebars.sbLeft.lock();});this.handle.on('mousedown',function(e){core.sidebars.resize(o('#sb-left').el,'left');});this.handle.on('click',function(){if(core.sidebars.settings.leftSidebarClickOpen){core.sidebars.sbLeft.open();}});hoverintent(this.sidebar.el,function(){if(!core.sidebars.settings.leftSidebarClickOpen){core.sidebars.sbLeft.open();}},function(){core.sidebars.sbLeft.close();});},open:function(){var sidebarWidth=this.sidebar.clientWidth();if(this.sidebar.data&&this.sidebar.data.timeoutClose){clearTimeout(this.sidebar.data.timeoutClose);}
this.sidebar.css({'left':'0px'});o('#editor-region').css({'margin-left':sidebarWidth+'px'});setTimeout(function(){core.sidebars.settings.isLeftSidebarOpen=true;core.sidebars.sbLeft.sidebar.trigger('h-resize-init');core.active.updateTabDropdownVisibility();},300);},close:function(){var sidebarWidth=this.sidebar.clientWidth(),sidebarHandleWidth=this.handle.clientWidth();sidebarWidth=o('#sb-left').clientWidth();if(!core.sidebars.settings.leftLockedVisible){this.sidebar.css({'left':(-sidebarWidth+sidebarHandleWidth)+'px'});o('#editor-region').css({'margin-left':'15px'});setTimeout(function(){core.sidebars.settings.isLeftSidebarOpen=false;core.sidebars.sbLeft.sidebar.trigger('h-resize-init');core.active.updateTabDropdownVisibility();},300);}},lock:function(){if(core.sidebars.settings.leftLockedVisible){this.icon.replaceClass('icon-lock-close','icon-lock-open');}else{this.icon.replaceClass('icon-lock-open','icon-lock-close');}
core.sidebars.settings.leftLockedVisible=!(core.sidebars.settings.leftLockedVisible);localStorage.setItem('codiad.sidebars.sb-left-lock',core.sidebars.settings.leftLockedVisible);}},sbRight:{sidebar:'',handle:'',icon:'',init:function(){this.sidebar=o('#sb-right');this.handle=o('#sb-right-handle');this.icon=o('#sb-right-lock');this.icon.on('click',function(e){core.sidebars.sbRight.lock();});this.handle.on('mousedown',function(e){core.sidebars.resize(o('#sb-right').el,'right');});this.handle.on('click',function(){if(core.sidebars.settings.rightSidebarClickOpen){core.sidebars.sbRight.open();}});hoverintent(this.sidebar.el,function(){if(!core.sidebars.settings.rightSidebarClickOpen){core.sidebars.sbRight.open();}},function(){core.sidebars.sbRight.close();});},open:function(){var sidebarWidth=this.sidebar.clientWidth();if(this.sidebar.data&&this.sidebar.data.timeoutClose){clearTimeout(this.sidebar.data.timeoutClose);}
this.sidebar.css({'right':'0px'});o('#editor-region').css({'margin-right':sidebarWidth+'px'});setTimeout(function(){core.sidebars.settings.isRightSidebarOpen=true;core.sidebars.sbRight.sidebar.trigger('h-resize-init');core.active.updateTabDropdownVisibility();},300);o('#tab-close').style.marginRight=(sidebarWidth-10)+'px';o('#tab-dropdown').style.marginRight=(sidebarWidth-10)+'px';},close:function(){var sidebarWidth=this.sidebar.clientWidth(),sidebarHandleWidth=this.handle.clientWidth();if(!core.sidebars.settings.rightLockedVisible){this.sidebar.css({'right':-(sidebarWidth-sidebarHandleWidth)+'px'});o('#editor-region').css({'margin-right':'15px'});setTimeout(function(){core.sidebars.settings.isRightSidebarOpen=false;core.sidebars.sbRight.sidebar.trigger('h-resize-init');core.active.updateTabDropdownVisibility();core.helpers.trigger(window,'resize');},300);o('#tab-close').style.marginRight='0px';o('#tab-dropdown').style.marginRight='0px';}},lock:function(){if(core.sidebars.settings.rightLockedVisible){this.icon.replaceClass('icon-lock-close','icon-lock-open');}else{this.icon.replaceClass('icon-lock-open','icon-lock-close');}
core.sidebars.settings.rightLockedVisible=!(core.sidebars.settings.rightLockedVisible);localStorage.setItem('codiad.sidebars.sb-right-lock',core.sidebars.settings.rightLockedVisible);core.helpers.trigger(window,'resize');}},resize:function(sidebar,side){var rect=sidebar.getBoundingClientRect(),modalX=rect.left;function moveElement(event){if(sidebar!==null){if(side==='left'){sidebar.style.width=(modalX+event.clientX+10)+'px';}else{sidebar.style.width=(window.innerWidth-event.clientX+10)+'px';}
...
function removeListeners(){core.helpers.trigger(window,'resize');localStorage.setItem('codiad.sidebars.sb-left-width',o('#sb-left').style.width);localStorage.setItem('codiad.sidebars.sb-right-width',o('#sb-right').style.width);document.removeEventListener('mousemove',moveElement,false);document.removeEventListener('mouseup',removeListeners,false);}
document.addEventListener('mousemove',moveElement,false);document.addEventListener('mouseup',removeListeners,false);}};})(this);;(function(global){'use strict';var core=global.codiad;core.confirm={icons:{'error':'exclamation-circle','notice':'info-circle','success':'check-circle','warning':'exclamation-triangle'},init:function(){},createConfirm:function(text,type){var overlay=document.createElement('div'),dialog=document.createElement('div'),actions=document.createElement('div');overlay.id='confirm-overlay';dialog.id='confirm-dialog';actions.classList.add('actions');dialog.appendChild(document.createElement('h2'));dialog.appendChild(actions);overlay.appendChild(dialog);document.body.appendChild(overlay);return overlay;},showConfirm:function(options){if(options&&typeof options==='object'){var overlay=document.querySelector('#confirm-overlay')||this.createConfirm(),dialog=overlay.querySelector('#confirm-dialog'),message=dialog.querySelector('h2'),actions=dialog.querySelector('.actions');overlay.style.display='block';if(options.message){message.innerText=options.message;}
var confirm=document.createElement('button');var deny=document.createElement('button');confirm.innerText=options.confirm.message;deny.innerText=options.deny.message;confirm.addEventListener('click',function(){options.confirm.fnc();overlay.style.display='none';});deny.addEventListener('click',function(){options.deny.fnc();overlay.style.display='none';});actions.innerHTML='';actions.appendChild(confirm);actions.appendChild(deny);}}};})(this);;(function(global,$){'use strict';var core=global.codiad,ajax=global.ajax,amplify=global.amplify,o=global.onyx;core.modal={settings:{isModalVisible:false},init:function(){console.log('Modal Initialized');},createModal:function(){var modal=core.modal;var overlay=o('<div>'),wrapper=o('<div>'),content=o('<div>'),drag=o('<i>'),close=o('<i>');overlay.attr('id','modal_overlay');overlay.on('click',function(event){if(event.target.id!=='modal_overlay'){return;}
modal.unload();},false);wrapper.attr('id','modal_wrapper');content.attr('id','modal_content');close.addClass('icon-cancel');close.on('click',modal.unload);drag.addClass('icon-arrows');drag.on('mousedown',function(){drag.addClass('active');modal.drag(wrapper);},false);wrapper.append(close);wrapper.append(drag);wrapper.append(content);document.body.appendChild(wrapper.el);document.body.appendChild(overlay.el);return wrapper;},load:function(width,url,data){data=data||{};width=width>400?width:400;var wrapper=o('#modal_wrapper')||this.createModal(),content=o('#modal_content');wrapper.css({'top':'15%','left':'calc(50% - '+(width / 2)+'px)','min-width':width+'px'});content.html('<div id="modal_loading"></div>');this.loadProcess=ajax({url:url,data:data,success:function(data){$('#modal_content').html(data);var input=wrapper.find('input[autofocus="autofocus"]');if(input){input.focus();}}});amplify.publish('modal.onLoad',{animationPerformed:false});wrapper.css({'display':'block'});o('#modal_overlay').css({'display':'block'});this.settings.isModalVisible=true;},hideOverlay:function(){o('#modal_overlay').style.display='none';},hide:function(){var wrapper=o('#modal_wrapper'),overlay=o('#modal_overlay');wrapper.removeClass('modal-active');overlay.removeClass('modal-active');wrapper.on('transitionend',function(){wrapper.remove();overlay.remove();});core.editor.focus();this.settings.isModalVisible=false;},unload:function(){amplify.publish('modal.onUnload',{animationPerformed:false});o('#modal_overlay').css({'display':''});o('#modal_wrapper').css({'display':''});o('#modal_content').empty();core.modal.settings.isModalVisible=false;core.editor.focus();},drag:function(wrapper){var rect=wrapper.offset(),mouseX=window.event.clientX,mouseY=window.event.clientY,modalX=rect.left,modalY=rect.top;function moveElement(event){if(wrapper!==null){wrapper.style.left=modalX+event.clientX-mouseX+'px';wrapper.style.top=modalY+event.clientY-mouseY+'px';}}
function removeListeners(){document.removeEventListener('mousemove',moveElement,false);document.removeEventListener('mouseup',removeListeners,false);o('.icon-arrows.active').removeClass('active');}
document.addEventListener('mousemove',moveElement,false);document.addEventListener('mouseup',removeListeners,false);}};})(this,jQuery);;(function(global){'use strict';var core=global.codiad;core.toast={icons:{'error':'exclamation-circle','notice':'info-circle','success':'check-circle','warning':'exclamation-triangle'},settings:{stayTime:3000,text:'',sticky:false,type:'info-circle',position:'bottom-right',close:null},init:function(options){if(options){this.settings=core.helpers.extend(this.settings,options);}},createContainer:function(){var container=document.createElement('div');container.id='toast-container';container.classList.add('toast-position-'+this.settings.position);document.body.appendChild(container);return container;},createToast:function(text,type){var wrapper=document.createElement('div'),message=document.createElement('p'),icon=document.createElement('i'),close=document.createElement('i');wrapper.classList.add('toast-wrapper');message.classList.add('toast-message');message.innerText=text||'Default Text';icon.classList.add('fas','fa-'+type,'toast-icon');close.classList.add('fas','fa-times-circle','toast-close');wrapper.appendChild(icon);wrapper.appendChild(message);wrapper.appendChild(close);close.addEventListener('click',function(){core.message.hide(wrapper);});return wrapper;},showToast:function(options){options=core.helpers.extend(this.settings,options);var container=document.querySelector('#toast-container')||this.createContainer(),wrapper=this.createToast(options.text,options.type);container.appendChild(wrapper);setTimeout(function(){wrapper.classList.add('toast-active');if(!options.sticky){setTimeout(function(){core.toast.hide(wrapper);},options.stayTime);}},10);return wrapper;},success:function(message,options){options=(options&&typeof options==='object')?options:{};options.text=message||'Message undefined';options.type=this.icons.success;this.showToast(options);},error:function(message,options){options=(options&&typeof options==='object')?options:{};options.text=message||'Message undefined';options.type=this.icons.error;options.stayTime=10000;this.showToast(options);},warning:function(message,options){options=(options&&typeof options==='object')?options:{};options.text=message||'Message undefined';options.type=this.icons.warning;options.stayTime=5000;this.showToast(options);},notice:function(message,options){options=(options&&typeof options==='object')?options:{};options.text=message||'Message undefined';options.type=this.icons.notice;this.showToast(options);},hide:function(wrapper){wrapper.classList.remove('toast-active');wrapper.addEventListener("transitionend",function(){wrapper.remove();});}};core.message=core.toast;})(this);;(function(global){'use strict';var core=global.codiad;core.jsend={parse:function(data){var obj=JSON.parse(data);if(obj.debug!==undefined&&Array.isArray(obj.debug)){var debug=obj.debug.join('\nDEBUG: ');if(debug!==''){debug='DEBUG: '+debug;}
console.log(debug);}
if(obj.status=='error'){core.toast.error(obj.message);return'error';}else{return obj.data;}}};})(this);;;