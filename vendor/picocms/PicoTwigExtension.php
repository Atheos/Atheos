	...
	*/
	public function getFilters() {
		return array(
			...
			'excerpt' => new Twig_SimpleFilter('excerpt', array($this, 'excerptGenerator'))
		);
	}

	public function excerptGenerator($raw_content) {
		$start = strpos($raw_content, "---", 5);
		$excerpt = substr($raw_content, $start + 3, $start + 200) . "...";
		return $excerpt;
	}
